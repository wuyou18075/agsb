...
UUID = os.getenv("UUID", "")  # UUID，默认值为指定的UUID
PORT = int(os.getenv("PORT", ""))  # Vmess端口，留空或0则自动生成
DOMAIN = os.getenv("DOMAIN", "")  # 域名，留空则自动获取
CF_TOKEN = os.getenv("TOKEN", "")  # Cloudflare Token，默认值为空（使用Quick Tunnel）
# =========================================
